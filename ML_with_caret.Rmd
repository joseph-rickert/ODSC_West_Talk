...
caret (short for Classification and REgression Training) is the most feature rich package for doing machine learning in R. It provides helper functions to streamline the entire modeling process and includes over 230 algorithms in a single framework.
